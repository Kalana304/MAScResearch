...
sigma_e = [4.4, 7.8]';  % heterogeneity in e cells
sigma_i = [2.5, 16.25]';  % heterogeneity in i cells
...
for q = 1 : Trials
    ...
    for t = 1 : T
        ...
        U_e(:, t + 1) = U_e(:, t) + dt * alpha_e .* (-U_e(:, t) + b * V_e(:, t) + ...
                        w_ee * F(U_e(:, t) - C * A * U_e(:, t), sigma_e) + ...
...
figure(2)
subplot(1, 2, 1);
plot(Ue_trial(1, :), Fe_trial(1, :), 'LineWidth', 1.2)
subplot(1, 2, 2);
plot(Ue_trial(2, :), Fe_trial(2, :), 'LineWidth', 1.2)
