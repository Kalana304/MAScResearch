...
def dimreduction(dataDict, xVar='I', **params):
    """
        This fucntion uses Kernel PCA method to reduce the dimensionality of
        system singularity points from 2N-dimension to 1-dimension plot. 

        parameters:
            dataDict:   (dict) a dictionary of singularity points and variable
            xVar:       (str) the variable changed continuously in the system
            params:     (kwargs) the parameters of the system simulation
        
        returns:
            dataDF:     (dataframe) reduced system singular points
    """
