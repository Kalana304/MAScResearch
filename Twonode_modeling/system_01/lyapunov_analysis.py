...
params['dt'] = 0.0025    #x10ms 
params['D0'] = 0.000 / (params['gamma'] * params['gamma'])   # Noise variance (by default this was set to 0)
...
for nI, I in enumerate(iPert):
    ...
    file_name = f"lyap_ie_{params['i_e1']:.3f}_dt_{params['dt']}"
