...
root_dir = "./results/functional/"

save_str = datetime.datetime(2024, 3, 25)
        ...
        for nK, K in enumerate(Karr):
            ...
            for nse, _sige in enumerate(sigArr):
                ...
                for nsi, _sigi in enumerate(sigArr):
                    ...
                    fileName = f"Imod_{params['i_mod']:.3f}mV_KGlob_{params['Kglob']:.2f}_sige_{params['sigma'][0]:.3f}_sigi_{params['sigma'][1]:.3f}_sigVar_{_sigvar:.2f}.pkl"
