...
for nV, _sigvar in enumerate(sigVar):
    ...
    for I in modAmp:
        ...
        for nK, K in enumerate(Karr):
            ...
            fileName = f"Imod_{params['i_mod']:.3f}mV_KGlob_{params['Kglob']:.2f}_sigVar_{_sigvar:.2f}"
            ...
            with open(os.path.join(save_dir, fileName + "_results.pkl"), "wb") as _file:
                pickle.dump(results_dict, _file)